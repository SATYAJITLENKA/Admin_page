...
const deleteEmployee = async (req, res) => {
  try {
    ...
    console.log('Deleting employee with ID:', employeeId); // Add this line for debugging
...
const editEmployee = async (req, res) => {
  try {
    const employeeId = req.params.employeeId;
    const { name, email, mobile, designation, gender, courses } = req.body; // Change from "course" to "courses"
